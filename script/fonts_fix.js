 ...
 * 但是还是疯狂的去做了
 */
Fonts_fix.prototype.char_px_yh={A:13,B:12,C:13,D:14,E:10,F:10,G:14,H:15,I:6,J:8,K:12,L:10,M:19,N:15,O:15,P:12,Q:15,R:12,S:11,T:11,U:14,
 ...
 //哇哦有够长的 - 还有一份
Fonts_fix.prototype.char_px_th={A:10,B:10,C:10,D:12,E:10,F:9,G:12,H:12,I:6,J:7,K:10,L:8,M:14,N:12,O:12,P:9,Q:12,R:11,S:10,T:10,U:11,
...
/* 等待压缩进入 */
Fonts_fix.prototype.char_px_th[' ']=5; //Tahoma的字符
Fonts_fix.prototype.char_px_th['@']=16;
Fonts_fix.prototype.char_px_th['!']=5;
Fonts_fix.prototype.char_px_th['?']=8;
Fonts_fix.prototype.char_px_th['+']=13;
Fonts_fix.prototype.char_px_th['=']=13;
Fonts_fix.prototype.char_px_th['-']=6;
Fonts_fix.prototype.char_px_th['#']=13;
Fonts_fix.prototype.char_px_th['$']=9;
Fonts_fix.prototype.char_px_th['%']=18;
Fonts_fix.prototype.char_px_th['^']=13;
Fonts_fix.prototype.char_px_th['&']=12;
Fonts_fix.prototype.char_px_th['*']=9;
Fonts_fix.prototype.char_px_th['\\']=6;
Fonts_fix.prototype.char_px_th['/']=6;
Fonts_fix.prototype.char_px_th['`']=9;
...
Fonts_fix.prototype.char_px_th[':']=6;
Fonts_fix.prototype.char_px_th[';']=6;
Fonts_fix.prototype.char_px_th['_']=10;
Fonts_fix.prototype.char_px_th['\'']=3;
Fonts_fix.prototype.char_px_th['"']=7;
Fonts_fix.prototype.char_px_th['~']=13;
Fonts_fix.prototype.char_px_th['[']=6;
Fonts_fix.prototype.char_px_th[']']=6;
Fonts_fix.prototype.char_px_th['|']=6;
Fonts_fix.prototype.char_px_th['{']=8;
Fonts_fix.prototype.char_px_th['}']=8; //终于结束了 - 更多的字体伤不起
...
Fonts_fix.prototype = {
    ...
    fix: function(str, blanks) {
        var len = str_getfixedlen(str);
        for (var i = 0; i < blanks - len; i++) {
            str += " "; //是的很笨 - 但是我不知道怎么做
        }
        return str;
    }
